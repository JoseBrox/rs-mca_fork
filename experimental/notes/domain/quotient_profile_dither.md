...
This note accompanies `experimental/scripts/quotient_profile_dither.py`.  It implements the
...
`experimental/scripts/m1_occupancy_profile_scan.py` gives the theorem-backed complete
